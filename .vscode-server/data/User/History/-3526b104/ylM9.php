...
Route::get('/employee/data', [EmployeeController::class ,'employeeTable']);
Route::get('/employee/dataleave', [EmployeeController::class ,'leaveTable']);
Route::get('/employee/dataapproving', [EmployeeController::class ,'approvinggroupTable']);
Route::get('/employee/leave', [EmployeeController::class ,'getnoofdays']);
Route::any('/employee/save', [EmployeeController::class ,'saveemployee']);
Route::any('/employee/savecredit', [EmployeeController::class ,'savecredit']);
Route::any('/employee/update', [EmployeeController::class ,'updateemployee']);
