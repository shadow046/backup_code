    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div>
            <label class="control-label col-sm-5" for="noofdaystoavail">No of Days to avail:</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="noofdaystoavail" style=""  placeholder="Enter the no. of days to avail" required>
            </div>
          </div>
          <div class="form-group my-4">
            <span class="col-sm-12">&nbsp;</span>
          ...
          <div class="form-group my-4">
            <label class="control-label col-sm-4" for="activation">Activation:</label>
            <div class="col-sm-8">
