      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group my-4">
            ...
            <div class="col-sm-8">
              <select class="form-control" id="region" style="margin-top:-8px !important; color: Gray;" required>
                <option value="" selected disabled style="color: Gray;">Select Region</option>
              </select>
            </div>
          </div>
          <div class="form-group my-4">
