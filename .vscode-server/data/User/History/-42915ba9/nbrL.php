      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group my-4">
            ...
            <div class="col-sm-8">
              <select class="form-control" id="province" style="margin-top:-8px !important; color: Gray;" required>
                ...
                {{-- @foreach($provincetypes as $provincetype)
                  <option value="{{$provincetype->provCode}}" style="color: Black;">{{strtoupper($provincetype->provDesc)}}</option>
                @endforeach --}}
                @foreach ($countries as $country) 
                <option value="{{$provincetype->provCode}}">{{$provincetype->provDesc}}</option>
              @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="form-group my-4">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="region" style="margin-top:-8px !important;"  placeholder="Enter Region" required>
            </div>
          </div>
          <div class="form-group my-4">
            <span class="col-sm-12">&nbsp;</span>
