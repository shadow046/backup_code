      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group my-4">
            ...
            <div class="col-sm-8">
              <input type="date" class="form-control" id="address" style="margin-top:-8px !important;"  placeholder="Enter branch address" required>
            </div>
          </div>
          <div class="form-group my-4">
            <span class="col-sm-12">&nbsp;</span>
          ...
          <div class="form-group my-4">
            ...
            <div class="col-sm-8">
              <input type="date" class="form-control" id="region" style="margin-top:-8px !important;"  placeholder="Enter Region" required>
            </div>
          </div>
          <div class="form-group my-4">
            <span class="col-sm-12">&nbsp;</span>
