      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group my-4">
            <label class="control-label col-sm-3" for="employeeleave">Leave:</label>
            <div class="col-sm-9">
          ...
          <div class="form-group my-4">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="noofdays" style="margin-top:-8px !important;"  placeholder="0" disabled>
            </div>
            <div class="form-group my-4">
              <span class="col-sm-12">&nbsp;</span>
            </div>
            <input type="button" id="btnAdd" class="btn btn-primary bp" value="Add">
          </div>
          </form>
          <table id="leaveTable" class="table userTable table-hover display" style="cursor: pointer; width: 100%; font-size: 14px;">
