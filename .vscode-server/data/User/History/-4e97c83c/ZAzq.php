                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            {{-- <div class="col-md-6"> --}}
                                <center>
                                <input id="email" type="email" title = "Please input email address" style="width: 65%" placeholder="Username" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </center>
                                @error('email')
