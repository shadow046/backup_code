...
<div class="container-fluid">
    <button class="btn btn-primary bp float-right" type="button" id="btnAddUser" data-toggle="modal" data-target="#newuser" data-backdrop="static" data-keyboard="false" >ADD USER</button>
