  ...
  <nav class="navbar navbar-expand-lg navbar-dark idsi" id="mainNav" style="height: 20px;">
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      {{-- <ul class="navbar-nav "> --}}
        <a class="nav-link" style="float: right; color: white; font-size: 16px; cursor: pointer;" onclick="$('#logout-form').submit();">
