    ...
    <div style="user-select:none;">
      ...
      <div class="mt-2 p-2 ml-auto align-self-end d-flex" style="float:right">
        <div style="text-align: right; font-size: 12px;">
            ...
            <a class="nav-link" style="height: 50px; line-height: 40px; text-decoration: none !important; float: right; font-size: 16px; cursor: pointer;" onclick="$('#logout-form').submit();">
