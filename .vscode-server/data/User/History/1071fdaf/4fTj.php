...
class LeaveController extends Controller
{
    ...
    public function validate_updateleave(Request $request)
    {
        ...
        if($currentcode ==$request->leavecode && $currenttype == $request->leavetype && $currentnoofdays == $request->noofdays&& $currentfrommonth == $request->availmonthfrom && $currenttomonth == $request->availmonthto && $currentpriortoavail == $request->noofdaystoavail){
                // $email = 0;
                $result = "nochanges";
            }
            else{
