      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group my-4">
            <label class="control-label col-sm-2" for="holidayname">Holiday Name:</label>
            <div class="col-sm-9">
          ...
          <div class="form-group my-4">
            <label class="control-label col-sm-3" for="holidaytype">Holiday Type:</label>
            <div class="col-sm-9">
              <select class="form-control" id="holidaytype" style="margin-top:-8px !important; color: Gray;" required>
                ...
                @foreach($holiday as $holidays)
                  <option value="{{$holidays->name}}" style="color: Black;">{{strtoupper($holidays->name)}}</option>
                @endforeach
              </select>
            </div>
          </div>
