...
<button class="btn btn-primary bp" style="float: right; margin-right:3px;" type="button" id="btnImportEmployee" data-toggle="modal" data-target="" data-backdrop="static" data-keyboard="false" >IMPORT</button>
