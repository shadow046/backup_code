@extends('layouts.app')
@section('content')
<button class="btn btn-primary bp" style="float: right; " type="button" id="btnAddEmployee" data-toggle="modal" data-target="#newbranch" data-backdrop="static" data-keyboard="false" >ADD NEW</button>
