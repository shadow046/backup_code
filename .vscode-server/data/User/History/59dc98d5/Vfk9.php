...
<button class="btn btn-primary bp" style="float: right" type="button" id="btnImportEmployee" data-toggle="modal" data-target="#newbranch" data-backdrop="static" data-keyboard="false" >ADD NEW</button>
