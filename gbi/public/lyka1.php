...
echo "$puti
";
$user = 'dinopol13';//readline('Enter dummy username: ');
$pass = 'jerome123';//readline('Enter dummy pasword: ');
$user2 = 'emorej046';//readline('Enter main username: ');
$pass2 = 'Maricaris24';//readline('Enter main pasword: ');
//$pass;
//$pass = ''b'
// For output
//echo $a;
